...
class scrape:
    ...
    def _clear_log_file(self):
        try:
            ...
            self.logger.exception("Failed to clear the log file", error.LoggerClearError(e))
    ...
    def _save_log_copy(self,save_path):
        try:
            ...
            self.logger.exception(f"Failed to save the log file copy to the given path{save_path}", error.LoggerClearError(e))
